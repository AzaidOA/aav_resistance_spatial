#!/bin/bash
#$ -N soupx_SRR16502309
#$ -o /export/storage/users/azaid/vallabh_lab/work/SRR16502309/soupx_matrix/stdout.log
#$ -e /export/storage/users/azaid/vallabh_lab/work/SRR16502309/soupx_matrix/stderr.log
#$ -l h_vmem=80G
#$ -pe smp 8
